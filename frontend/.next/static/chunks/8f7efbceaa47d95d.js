(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,515034,e=>{"use strict";var r=e.i(983232);let o=r.styled.div`
  display: flex;
...
`;e.s(["S",()=>o])},630079,e=>{"use strict";var r=e.i(983232);let o=r.css`
  && {
    border-width: 1px;
    padding: 0.5rem 1rem;
  }
...
`,t=r.styled.div`
  ${o}
`;e.s(["B",()=>t,"a",()=>o])},546642,e=>{"use strict";var r=e.i(983232);let o=r.styled.span`
  color: var(--privy-color-foreground-3);
  font-size: 0.75rem;
  font-weight: 500;
  line-height: 1.125rem; /* 150% */
`;e.s(["L",()=>o])},568925,e=>{"use strict";var r=e.i(68013),o=e.i(72315),t=e.i(534912),i=e.i(575659),a=e.i(983232),n=e.i(299101),l=e.i(880684),s=e.i(546642),c=e.i(866848),d=e.i(630079);let u=(0,a.styled)(d.B)`
  && {
    padding: 0.75rem;
    height: 56px;
  }
...
`,A=({backFn:e})=>(0,r.jsx)("div",{children:(0,r.jsx)(D,{onClick:e,children:(0,r.jsx)(a.default,{height:"16px",width:"16px",strokeWidth:2})})}),z=({infoFn:e})=>(0,r.jsx)("div",{children:(0,r.jsx)(Z,{"aria-label":"info",onClick:e,children:(0,r.jsx)(n.default,{height:"22px",width:"22px",strokeWidth:2})})}),F=e=>(0,r.jsx)("div",{children:(0,r.jsx)(D,{"aria-label":"close modal",onClick:e.onClose,children:(0,r.jsx)(s,{height:"16px",width:"16px",strokeWidth:2})})}),E=({backFn:e,infoFn:o,onClose:i,title:a,closeable:n=!0,className:l})=>{let{closePrivyModal:s}=(0,c.u)(),d=(0,t.u)();return(0,r.jsxs)(P,{className:l,children:[(0,r.jsxs)(B,{children:[e&&(0,r.jsx)(A,{backFn:e}),(0,r.jsx)("div",{style:{height:24}}),o&&(0,r.jsx)(z,{infoFn:o})]}),a&&(0,r.jsx)(U,{id:"privy-dialog-title",children:a}),(0,r.jsx)(L,{children:!d.render.standalone&&n&&(0,r.jsx)(F,{onClose:i||(()=>s())})})]})},D=o.styled.button`
  && {
    cursor: pointer;
    display: flex;
    opacity: 0.6;
...
`;e.s(["A",()=>s])},549437,e=>{"use strict";var r=e.i(364921),o=e.i(26645);function t(e){return e?`${e.slice(0,5)}…${e.slice(-4)}`:""}function i({wei:e,precision:o=3}){return parseFloat((0,r.formatEther)(e)).toFixed(o).replace(/0+$/,"").replace(/\.$/,"")}function a({amount:e,decimals:r}){return(0,o.formatUnits)(BigInt(e),r)}e.s(["formatTokenAmount",()=>a,"formatWalletAddress",()=>t,"formatWeiAmount",()=>i])},206030,e=>{"use strict";e.s(["O",()=>"sdk_fiat_on_ramp_completed_with_status"])},842581,e=>{"use strict";var r=e.i(68013),o=e.i(725991),t=e.i(299101);function i({title:e}){let{currentScreen:i,navigateBack:a,navigate:n,data:l,setModalData:s}=(0,o.a)();return(0,r.jsx)(t.M,{title:e,backFn:"ManualTransferScreen"===i?a:i===l?.funding?.methodScreen?l.funding.comingFromSendTransactionScreen?()=>n("SendTransactionScreen"):void 0:l?.funding?.methodScreen?()=>{let e=l.funding;e.usingDefaultFundingMethod&&(e.usingDefaultFundingMethod=!1),s({funding:e,solanaFundingData:l?.solanaFundingData}),n(e.methodScreen)}:void 0})}e.s(["t",()=>i])},415198,e=>{"use strict";function r(e){switch(e){case"solana:mainnet":return"Solana";case"solana:devnet":return"Devnet";case"solana:testnet":return"Testnet"}}e.s(["g",()=>r])},594661,e=>{"use strict";var r=e.i(731277),o=e.i(465551),t=e.i(803669);let i=async({chain:e,address:i,appId:n,rpcConfig:l,erc20Address:s})=>{let c=(0,r.createPublicClient)({chain:e,transport:(0,o.http)((0,t.a)(e,l,n))});return{balance:await c.readContract({address:s,abi:a,functionName:"balanceOf",args:[i]}).catch(()=>0n),chain:e}},a=[{constant:!0,inputs:[{name:"_owner",type:"address"}],name:"balanceOf",outputs:[{name:"balance",type:"uint256"}],payable:!1,stateMutability:"view",type:"function"}];e.s(["g",()=>i])},99419,e=>{"use strict";var r=e.i(348143);function o(e){let[o]=Object.entries(r.D[e]).find(([e,r])=>"USDC"===r.symbol)??[];return o}e.s(["g",()=>o])},74590,e=>{"use strict";var r=e.i(575659),o=e.i(731277),t=e.i(465551),i=e.i(803669),a=e.i(608304);function n({rpcConfig:e,appId:n,address:l,chain:s}){let{chains:c}=(0,a.u)(),[d,u]=(0,r.useState)(0n),[v,p]=(0,r.useState)(!1),h=(0,r.useMemo)(()=>{let r=s||c[0];if(r)return(0,o.createPublicClient)({chain:s,transport:(0,t.http)((0,i.a)(r,e,n))})},[s,e,n]),g=(0,r.useCallback)(async()=>{if(!l||!h)return;p(!0);let e=await h.getBalance({address:l}).catch(console.error);return e?(u(e),p(!1),e):void 0},[h,l,u]);return(0,r.useEffect)(()=>{g().catch(console.error)},[]),{balance:d,isLoading:v,reloadBalance:g}}e.s(["u",()=>n])},760389,e=>{"use strict";var r=e.i(68013),o=e.i(575659);let t=o.forwardRef(function({title:e,titleId:r,...t},i){return o.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor","aria-hidden":"true","data-slot":"icon",ref:i,"aria-labelledby":r},t),e?o.createElement("title",{id:r},e):null,o.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z"}))});var i=e.i(983232);let a=({children:e,theme:o})=>(0,r.jsxs)(n,{$theme:o,children:[(0,r.jsx)(t,{width:"20px",height:"20px",color:"var(--privy-color-icon-subtle)",strokeWidth:2,style:{flexShrink:0}}),(0,r.jsx)(l,{$theme:o,children:e})]}),n=i.styled.div`
  display: flex;
  gap: 0.75rem;
  background-color: var(--privy-color-background-2);
  align-items: flex-start;
...
`,l=i.styled.div`
  ...
  flex: 1;
  text-align: left;
`;e.s(["I",()=>a],760389)},946329,e=>{"use strict";var r=e.i(68013),o=e.i(575659),t=e.i(26645),i=e.i(549437),a=e.i(299101),n=e.i(515034),l=e.i(29807),s=e.i(842581),c=e.i(760389),d=e.i(163655),u=e.i(928064),v=e.i(568925),p=e.i(52783),h=e.i(704395),g=e.i(608304),f=e.i(725991),y=e.i(74590),m=e.i(247063),b=e.i(206030),x=e.i(946547),k=e.i(415198),w=e.i(99419),j=e.i(602926),C=e.i(594661);e.i(302485),e.i(123987),e.i(550615),e.i(993378),e.i(124602),e.i(45686);let S={component:()=>{let{wallets:e}=(0,m.u)(),{connectors:S}=(0,g.u)(),M=S.filter(h.v).flatMap(e=>e.wallets),{data:T,setModalData:A,navigate:z,lastScreen:F}=(0,f.a)(),{rpcConfig:E,appId:D,createAnalyticsEvent:Z,closePrivyModal:P}=(0,g.u)(),B=(0,p.u)(),[L,U]=(0,o.useState)(void 0),[N,V]=(0,o.useState)(!1),I=T?.funding,{reloadBalance:_}=(0,y.u)({rpcConfig:E,appId:D,address:"ethereum"===I.chainType?I.address:void 0,chain:"ethereum"===I.chainType?I.chain:void 0}),W="solana"===I.chainType,O=W?I.isUSDC?"USDC":"SOL":I.erc20Address?I.erc20ContractInfo?.symbol:I.chain.nativeCurrency.symbol,H=W?M.find(({address:e})=>e===I.address):e.find(({address:e})=>(0,h.D)(e)===(0,h.D)(I.address));if(!I)return A({errorModalData:{error:Error("Couldn't find funding config"),previousScreen:F||"FundingMethodSelectionScreen"},funding:T?.funding,solanaFundingData:T?.solanaFundingData,sendTransaction:T?.sendTransaction}),z("ErrorScreen"),(0,r.jsx)(r.Fragment,{});(0,o.useEffect)(()=>{let e=W?async function(){if("solana"!==I.chainType)return;let e=B.solanaRpcs[I.chain];e?(I.isUSDC?async function({rpc:e,address:r,mintAddress:o}){let t=await e.getTokenAccountsByOwner(r,{mint:o},{encoding:"jsonParsed",commitment:"confirmed"}).send(),i=t.value[0]?.account;return i?BigInt(i.data.parsed.info.tokenAmount.amount):0n}({rpc:e.rpc,address:I.address,mintAddress:(0,w.g)(I.chain)}):(0,x.x)({rpc:e.rpc,address:I.address})).then(e=>{let r=BigInt(e);L&&r>L&&(V(!0),Z({eventName:b.O,payload:{provider:"manual",status:"success",chainType:"solana",address:H?.address,value:I.isUSDC?(0,t.formatUnits)(r-L,6):(0,t.formatUnits)(r-L,9),token:I.isUSDC?"USDC":"SOL"}})),U(r)}):console.warn("Unable to load solana rpc, skipping balance")}:async function(){"ethereum"===I.chainType&&(async()=>{if(!I.erc20Address)return await _()??BigInt(0);{let{balance:e}=await (0,C.g)({chain:I.chain,address:I.address,erc20Address:I.erc20Address,rpcConfig:E,appId:D});return e}})().then(e=>{L&&e>L&&(V(!0),Z({eventName:b.O,payload:{provider:"manual",status:"success",chainType:"ethereum",address:H?.address,chainId:I.chain.id,value:(0,t.formatUnits)(e-L,I.erc20ContractInfo?.decimals??18),token:I.erc20ContractInfo?.symbol??I.erc20Address??"ETH"}})),U(e)}).catch(()=>U(void 0))},r=setInterval(e,2e3);return e(),()=>clearInterval(r)},[L]);let R=(0,o.useMemo)(()=>null==L?"":I.isUSDC?(0,i.formatTokenAmount)({amount:L,decimals:6}):W?(0,j.g)(L,3,!0,!0):null!=I.erc20ContractInfo?.decimals?(0,i.formatTokenAmount)({amount:L,decimals:I.erc20ContractInfo.decimals}):(0,i.formatWeiAmount)({wei:L}),[L,W,I]),q="ethereum"===I.chainType?I.chain.name:(0,k.g)(I.chain),G=(0,o.useMemo)(()=>""===I.uiConfig?.receiveFundsTitle?null:(0,r.jsx)(u.T,{children:I.uiConfig?.receiveFundsTitle??`Receive ${I.amount} ${O??""}`.trim()}),[I.uiConfig?.receiveFundsTitle,I.amount,O]),J=(0,o.useMemo)(()=>""===I.uiConfig?.receiveFundsSubtitle?null:(0,r.jsx)(d.S,{children:I.uiConfig?.receiveFundsSubtitle??`Scan this code or copy your wallet address to receive funds on ${q}.`}),[I.uiConfig?.receiveFundsSubtitle,q]),Q="solana"===I.chainType&&I.isUSDC&&(0,w.g)(I.chain)?`?spl-token=${(0,w.g)(I.chain)}`:"";return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(s.t,{}),G,J,(0,r.jsxs)(n.F,{style:{gap:"1rem",margin:G||J?"1rem 0":"0"},children:[(0,r.jsx)(l.Q,{url:`${I.chainType}:${I.address}${Q}`,size:200,squareLogoElement:$}),(0,r.jsxs)(c.I,{theme:B.appearance.palette.colorScheme,children:["Make sure to send funds on ",q,"."]}),(0,r.jsx)(v.W,{title:"Your wallet",errMsg:void 0,showCopyButton:!0,balance:`${R} ${O}`,address:I.address}),N&&(0,r.jsx)(a.P,{onClick:()=>P({shouldCallAuthOnSuccess:!1,isSuccess:!0}),children:"Continue"})]}),(0,r.jsx)(a.B,{})]})}},$=({...e})=>(0,r.jsx)(x.z,{color:"black",...e});e.s(["ManualTransferScreen",()=>S,"default",()=>S])}]);