...
`;a.s(["D",()=>q,"E",()=>j,"H",()=>v,"I",()=>t,"N",()=>k,"P",()=>o,"R",()=>u,"S",()=>w,"a",()=>m,"b",()=>p,"c",()=>i,"d",()=>r,"e",()=>x,"f",()=>n,"g",()=>s],124164)},68644,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(228720),f=a.i(375761),g=a.i(487536),h=a.i(411672);a.i(721594),a.i(147775),a.i(534286),a.i(158638),a.i(463893),a.i(610997),a.i(357172),a.i(516911);let i={component:()=>{let{navigate:a,data:i,onUserCloseViaDialogOrKeybindRef:j}=(0,g.a)(),k=(0,d.u)(),[l,m]=(0,c.useState)(""),[n,o]=(0,c.useState)(!1),[p,q]=(0,c.useState)(),[r,s]=(0,c.useState)(null),{create:t}=(0,e.v)(),{authenticated:u,user:v}=(0,g.u)(),{closePrivyModal:w,isNewUserThisSession:x,initializeWalletProxy:y}=(0,f.u)(),{onSuccess:z,onFailure:A,callAuthOnSuccessOnClose:B,shouldCreateEth:C,shouldCreateSol:D}=i.createWallet,[E,F]=(0,c.useState)(null),G=new e.R(async()=>{try{let b;if(C&&D)b=await t({recoveryMethod:"user-passcode",recoveryPassword:p,chainType:"ethereum",walletIndex:0,latestUser:v}),b=await t({chainType:"solana",walletIndex:0,latestUser:b.user});else if(D)b=await t({recoveryMethod:"user-passcode",recoveryPassword:p,chainType:"solana",walletIndex:0,latestUser:v});else{if(!C)throw Error("Invalid args to create wallet");b=await t({recoveryMethod:"user-passcode",recoveryPassword:p,chainType:"ethereum",walletIndex:0,latestUser:v})}F(b),x?a("EmbeddedWalletCreatedScreen"):(z(b),w({shouldCallAuthOnSuccess:B}))}catch(a){m(a.message)}});return(0,c.useEffect)(()=>{r||y(3e4).then(a=>s(a))},[r]),(0,c.useEffect)(()=>{if(!u||!v)return a("LandingScreen"),void A(Error("User must be authenticated before creating a Privy wallet"))},[u]),j.current=()=>null,(0,b.jsx)(h.S,{config:{initiatedBy:"automatic"},appName:k?.name||"privy",loading:!r,buttonLoading:n,buttonHideAnimations:!E&&n,isResettingPassword:!1,error:l,password:p||"",onClose:()=>{E&&"user-passcode"!==E.account.recoveryMethod?(A(new f.m("User created a wallet but failed to set a password for it")),w({shouldCallAuthOnSuccess:!1})):E?(z(E),w({shouldCallAuthOnSuccess:B})):(A(new f.m("User wallet creation failed")),w({shouldCallAuthOnSuccess:!1}))},onPasswordChange:q,onPasswordGenerate:()=>q((0,h.g)()),onSubmit:async()=>(o(!0),G.execute().then(()=>new Promise(a=>setTimeout(a,250))).finally(()=>o(!1)))})}};a.s(["EmbeddedWalletPasswordCreateScreen",()=>i,"default",()=>i])}];

//# sourceMappingURL=a6365__pnpm_d60bd7b5._.js.map