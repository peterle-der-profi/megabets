...
`;a.s(["C",()=>g])},449888,a=>{"use strict";var b=a.i(352844),c=a.i(126520);let d=({data:a})=>{let c=a=>"object"==typeof a&&null!==a?(0,b.jsx)(f,{children:Object.entries(a).map(([a,d])=>(0,b.jsxs)("li",{children:[(0,b.jsxs)("strong",{children:[a,":"]})," ",c(d)]},a))}):(0,b.jsx)("span",{children:String(a)});return(0,b.jsx)("div",{children:c(a)})},e=c.styled.div`
  margin-top: 1.5rem;
...
`,g=({data:a,className:c})=>(0,b.jsx)(e,{className:c,children:(0,b.jsx)(d,{data:a})});a.s(["D",()=>g,"M",()=>e])},873375,a=>{"use strict";var b=a.i(352844),c=a.i(136110);let d=(0,a.i(489252).default)("square-pen",[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]]);var e=a.i(42783),f=a.i(126520),g=a.i(104408),h=a.i(677939),i=a.i(432961),j=a.i(316863),k=a.i(30960),l=a.i(449888),m=a.i(789042),n=a.i(847920),o=a.i(375761),p=a.i(487536),q=a.i(977538);a.i(147775),a.i(721594),a.i(534286);let r=f.styled.img`
  && {
...
`,s=a=>{let{types:c,primaryType:d,...e}=a.typedData;return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(x,{data:e}),(0,b.jsx)(j.C,{text:JSON.stringify(a.typedData,null,2),itemName:"full payload to clipboard"})," "]})},t=({method:a,messageData:e,copy:f,iconUrl:i,isLoading:j,success:l,walletProxyIsLoading:m,errorMessage:n,isCancellable:o,onSign:p,onCancel:t,onClose:u})=>(0,b.jsx)(q.S,{title:f.title,subtitle:f.description,showClose:!0,onClose:u,icon:d,iconVariant:"subtle",helpText:n?(0,b.jsx)(w,{children:n}):void 0,primaryCta:{label:f.buttonText,onClick:p,disabled:j||l||m,loading:j},secondaryCta:o?{label:"Not now",onClick:t,disabled:j||l||m}:void 0,watermark:!0,children:(0,b.jsxs)(k.a,{children:[i?(0,b.jsx)(r,{style:{alignSelf:"center"},size:"sm",src:i,alt:"app image"}):null,(0,b.jsxs)(v,{children:["personal_sign"===a&&(0,b.jsx)(y,{children:(a=>{if(!(0,g.isHex)(a))return a;try{let b=(0,h.hexToString)(a);return b.includes("�")?a:b}catch{return a}})(e)}),"eth_signTypedData_v4"===a&&(0,b.jsx)(s,{typedData:e}),"solana_signMessage"===a&&(0,b.jsx)(y,{children:(a=>{try{let b=c.base64.decode(a),d=(new TextDecoder).decode(b);return d.includes("�")?a:d}catch{return a}})(e)})]})]})}),u={component:()=>{let{authenticated:a}=(0,p.u)(),{initializeWalletProxy:c,closePrivyModal:d}=(0,o.u)(),{navigate:f,data:g,onUserCloseViaDialogOrKeybindRef:h}=(0,p.a)(),[j,k]=(0,e.useState)(!0),[l,q]=(0,e.useState)(""),[r,s]=(0,e.useState)(),[u,v]=(0,e.useState)(null),[w,x]=(0,e.useState)(!1);(0,e.useEffect)(()=>{a||f("LandingScreen")},[a]),(0,e.useEffect)(()=>{c(n.W).then(a=>{k(!1),a||(q("An error has occurred, please try again."),s(new m.P(new m.j(l,i.ProviderErrors.E32603_DEFAULT_INTERNAL_ERROR.eipCode))))})},[]);let{method:y,data:z,confirmAndSign:A,onSuccess:B,onFailure:C,uiOptions:D}=g.signMessage,E={title:D?.title||"Sign message",description:D?.description||"Signing this message will not cost you any fees.",buttonText:D?.buttonText||"Sign and continue"},F=a=>{a?B(a):C(r||new m.P(new m.j("The user rejected the request.",i.ProviderErrors.E4001_USER_REJECTED_REQUEST.eipCode))),d({shouldCallAuthOnSuccess:!1}),setTimeout(()=>{v(null),q(""),s(void 0)},200)};return h.current=()=>{F(u)},(0,b.jsx)(t,{method:y,messageData:z,copy:E,iconUrl:D?.iconUrl&&"string"==typeof D.iconUrl?D.iconUrl:void 0,isLoading:w,success:null!==u,walletProxyIsLoading:j,errorMessage:l,isCancellable:D?.isCancellable,onSign:async()=>{x(!0),q("");try{let a=await A();v(a),x(!1),setTimeout(()=>{F(a)},n.q)}catch(a){console.error(a),q("An error has occurred, please try again."),s(new m.P(new m.j(l,i.ProviderErrors.E32603_DEFAULT_INTERNAL_ERROR.eipCode))),x(!1)}},onCancel:()=>F(null),onClose:()=>F(u)})}},v=f.styled.div`
  flex: 1;
  display: flex;
  flex-direction: column;
  gap: 16px;
...
`,y=(0,f.styled)(l.M)`
  margin-top: 0;
`;a.s(["SignRequestScreen",()=>u,"SignRequestView",()=>t,"default",()=>u],873375)}];

//# sourceMappingURL=a6365__pnpm_2ba5aea8._.js.map