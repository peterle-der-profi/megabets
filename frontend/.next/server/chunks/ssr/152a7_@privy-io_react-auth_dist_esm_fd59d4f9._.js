...
`;a.s(["E",()=>e,"I",()=>g,"a",()=>f])},260350,a=>{"use strict";var b=a.i(352844);let c=({...a})=>(0,b.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",...a,children:[(0,b.jsx)("rect",{width:"18",height:"18",x:"3",y:"3",rx:"2"}),(0,b.jsx)("path",{d:"M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2"}),(0,b.jsx)("path",{d:"M3 11h3c.8 0 1.6.3 2.1.9l1.1.9c1.6 1.6 4.1 1.6 5.7 0l1.1-.9c.5-.5 1.3-.9 2.1-.9H21"})]});a.s(["W",()=>c])},309840,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(375761),f=a.i(541242),g=a.i(487536),h=a.i(535812);a.i(721594),a.i(534286),a.i(147775),a.i(513929);let i={component:()=>{let{closePrivyModal:a}=(0,e.u)(),{data:i,navigate:j}=(0,g.a)(),k=(0,d.u)(),l=(0,f.a)(),m=i?.externalConnectWallet?.description,n=(0,c.useRef)(i?.externalConnectWallet?.walletList??k.appearance.walletList),o=(0,c.useRef)(i?.externalConnectWallet?.walletChainType??k.appearance.walletChainType);return(0,b.jsx)(h.i,{walletList:n.current,walletChainType:o.current,preSelectedWalletId:i?.externalConnectWallet?.preSelectedWalletId,hideHeader:i?.externalConnectWallet?.hideHeader,onBack:i?.funding?()=>j("FundingMethodSelectionScreen"):void 0,onClose:()=>{l("connectWallet","onError",e.b.GENERIC_CONNECT_WALLET_ERROR),a()},onConnect:({connector:b,wallet:c})=>{l("connectWallet","onSuccess",{wallet:c});let d=i?.externalConnectWallet?.onCompleteNavigateTo;d?j(d({address:c.address,walletClientType:b?.walletClientType,walletChainType:b?.chainType})):a()},onConnectError:a=>{a instanceof e.c?(console.warn(a.cause?a.cause:a.message),l("connectWallet","onError",a.privyErrorCode||e.b.GENERIC_CONNECT_WALLET_ERROR)):(console.warn(a),l("connectWallet","onError",e.b.UNKNOWN_CONNECT_WALLET_ERROR))},customDescription:m,app:k,connectOnly:!0})},isUnauthenticatedScreem:!0};a.s(["ConnectOnlyLandingScreen",()=>i,"default",()=>i])}];

//# sourceMappingURL=152a7_%40privy-io_react-auth_dist_esm_fd59d4f9._.js.map