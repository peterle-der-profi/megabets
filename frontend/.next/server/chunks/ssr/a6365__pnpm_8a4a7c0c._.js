...
`,a.s(["B",()=>c,"C",()=>f,"F",()=>h,"H",()=>e,"R",()=>l,"S",()=>j,"a",()=>i,"b",()=>k,"c",()=>g,"d",()=>m,"e",()=>d])},973949,a=>{"use strict";var b=a.i(126520);let c=b.styled.span`
  text-align: left;
  font-size: 0.75rem;
  font-weight: 500;
...
`;a.s(["E",()=>e,"I",()=>g,"a",()=>f])},705256,a=>{"use strict";let b=(0,a.i(489252).default)("mail",[["path",{d:"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7",key:"132q7q"}],["rect",{x:"2",y:"4",width:"20",height:"16",rx:"2",key:"izxlao"}]]);a.s(["Mail",()=>b],705256)},930391,a=>{"use strict";var b=a.i(42783);let c=b.forwardRef(function({title:a,titleId:c,...d},e){return b.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor","aria-hidden":"true","data-slot":"icon",ref:e,"aria-labelledby":c},d),a?b.createElement("title",{id:c},a):null,b.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"}))});a.s(["default",0,c])},846538,a=>{"use strict";var b=a.i(352844),c=a.i(930391),d=a.i(30960),e=a.i(705256),f=a.i(42783),g=a.i(847920),h=a.i(228720),i=a.i(375761),j=a.i(487536),k=a.i(400863),l=a.i(463080),m=a.i(344037),n=a.i(973949),o=a.i(977538);a.i(721594),a.i(147775),a.i(534286),a.i(158638),a.i(463893);let p=(0,f.forwardRef)((a,c)=>{let[d,m]=(0,f.useState)(""),[o,p]=(0,f.useState)(""),[s,t]=(0,f.useState)(!1),{authenticated:u,user:v}=(0,j.u)(),{initUpdateEmail:w}=(0,i.u)(),{navigate:x,setModalData:y,currentScreen:z}=(0,j.a)(),{enabled:A,token:B}=(0,h.a)(),C=(0,g.u)(),D=(0,k.a1)(d)&&(C.disablePlusEmails&&d.includes("+")?(o||p("Please enter a valid email address without a '+'."),!1):(o&&p(""),!0)),E=s||!D,F=()=>{!A||B||u?(async a=>{if(!v?.email)throw Error("User is required to have an email address to update it.");t(!0);try{await w({oldAddress:v.email.address,newAddress:d,captchaToken:a}),x("AwaitingPasswordlessCodeScreen")}catch(a){y({errorModalData:{error:a,previousScreen:z||"LandingScreen"}}),x("ErrorScreen")}t(!1)})(B):(y({captchaModalData:{callback:a=>{if(!v?.email)throw Error("User is required to have an email address to update it.");return w({oldAddress:v.email.address,newAddress:d,captchaToken:a})},userIntentRequired:!1,onSuccessNavigateTo:"AwaitingPasswordlessCodeScreen",onErrorNavigateTo:"ErrorScreen"}}),x("CaptchaScreen"))};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)(q,{children:[o&&(0,b.jsx)(n.E,{style:{marginTop:"0.25rem",textAlign:"left"},children:o}),(0,b.jsxs)(r,{$error:!!o,children:[(0,b.jsx)(k.V,{children:(0,b.jsx)(e.Mail,{})}),(0,b.jsx)("input",{ref:c,id:"email-input",type:"email",placeholder:"your@email.com",onChange:a=>m(a.target.value),onKeyUp:a=>{"Enter"===a.key&&F()},value:d,autoComplete:"email"}),a.stacked?null:(0,b.jsx)(l.E,{isSubmitting:s,onClick:F,disabled:E,children:"Submit"})]})]}),a.stacked?(0,b.jsx)(l.P,{loadingText:null,loading:s,disabled:E,onClick:F,style:{width:"100%"},children:"Submit"}):null]})}),q=m.I,r=m.E,s=({title:a="Update your email",subtitle:e="Add the email address you'd like to use going forward. We'll send you a confirmation code"})=>(0,b.jsx)(o.S,{title:a,subtitle:e,icon:c.default,watermark:!0,children:(0,b.jsx)(d.B,{children:(0,b.jsx)(p,{stacked:!0})})}),t={component:()=>(0,b.jsx)(s,{})};a.s(["UpdateEmailScreen",()=>t,"UpdateEmailScreenView",()=>s,"default",()=>t])}];

//# sourceMappingURL=a6365__pnpm_8a4a7c0c._.js.map