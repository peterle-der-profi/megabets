...
`;a.s(["T",()=>g,"a",()=>h],987813)},261550,a=>{"use strict";var b=a.i(352844),c=a.i(126520);let d=c.styled.a`
  && {
...
`,e=({size:a="md",variant:c="navigation",disabled:e=!1,as:f,children:g,onClick:h,...i})=>(0,b.jsx)(d,{as:f,$size:a,$variant:c,$disabled:e,onClick:a=>{e?a.preventDefault():h?.(a)},...i,children:g});a.s(["L",()=>e])},430672,a=>{"use strict";var b=a.i(352844),c=a.i(261550),d=a.i(987813),e=a.i(487536),f=a.i(977538);a.i(42783),a.i(721594),a.i(534286),a.i(147775);let g=({walletName:a,installLink:e,title:g,subtitle:h="Follow the instructions below to get started.",onReload:i,onBack:j})=>{let k=g||`Create a ${a} wallet`.replace(/wallet wallet/gi,"wallet");return(0,b.jsx)(f.S,{title:k,subtitle:h,onBack:j,showBack:!0,primaryCta:{label:"Reload the page to use your wallet",onClick:i},helpText:(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("span",{children:"Still not sure? "}),(0,b.jsx)(c.L,{size:"sm",target:"_blank",href:"https://solana.com/docs/intro/wallets",children:"Learn more"})]}),watermark:!0,children:(0,b.jsxs)(d.T,{children:[(0,b.jsx)(d.a,{children:(0,b.jsxs)("div",{children:[(0,b.jsx)("span",{children:"Install the "})," ",(0,b.jsxs)(c.L,{href:e,target:"_blank",children:[a," browser extension"]})]})}),(0,b.jsx)(d.a,{children:"Set up your first wallet"}),(0,b.jsx)(d.a,{children:"Store your recovery phrase in a safe place!"})]})})},h={component:()=>{let{navigateBack:a,data:c}=(0,e.a)();if(!c?.installWalletModalData)throw Error("Wallet data is missing");let{walletConfig:d}=c.installWalletModalData;return(0,b.jsx)(g,{walletName:d.name,installLink:d.installLink,onReload:()=>{window.location.reload()},onBack:a})}};a.s(["InstallWalletScreen",()=>h,"InstallWalletScreenView",()=>g,"default",()=>h])}];

//# sourceMappingURL=a6365__pnpm_0260f1d5._.js.map