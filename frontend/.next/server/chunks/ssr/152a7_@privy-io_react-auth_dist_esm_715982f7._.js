...
`;a.s(["C",()=>g])},832724,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(126520);let e=a=>{let[d,e]=(0,c.useState)(!1);return(0,b.jsx)(f,{color:a.color,href:a.url,target:"_blank",rel:"noreferrer noopener",onClick:()=>{e(!0),setTimeout(()=>e(!1),1500)},justOpened:d,children:a.text})},f=d.styled.a`
  display: flex;
  align-items: center;
  gap: 6px;
...
`;a.s(["O",()=>e])},816334,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(534286),e=a.i(126520),f=a.i(316863),g=a.i(400863),h=a.i(832724),i=a.i(557121),j=a.i(847920),k=a.i(375761),l=a.i(487536),m=a.i(977538),n=a.i(93224);a.i(147775),a.i(513929),a.i(721594);let o="#8a63d2",p=({appName:a,loading:c,success:e,errorMessage:j,connectUri:k,onBack:l,onClose:p,onOpenFarcaster:w})=>(0,b.jsx)(m.S,d.isMobile||c?d.isIOS?{title:j?j.message:"Add a signer to Farcaster",subtitle:j?j.detail:`This will allow ${a} to add casts, likes, follows, and more on your behalf.`,icon:n.F,iconVariant:"loading",iconLoadingStatus:{success:e,fail:!!j},primaryCta:k&&w?{label:"Open Farcaster app",onClick:w}:void 0,onBack:l,onClose:p,watermark:!0}:{title:j?j.message:"Requesting signer from Farcaster",subtitle:j?j.detail:"This should only take a moment",icon:n.F,iconVariant:"loading",iconLoadingStatus:{success:e,fail:!!j},onBack:l,onClose:p,watermark:!0,children:k&&d.isMobile&&(0,b.jsx)(q,{children:(0,b.jsx)(h.O,{text:"Take me to Farcaster",url:k,color:o})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${a} to add casts, likes, follows, and more on your behalf.`,onBack:l,onClose:p,watermark:!0,children:(0,b.jsxs)(r,{children:[(0,b.jsx)(s,{children:k?(0,b.jsx)(i.Q,{url:k,size:275,squareLogoElement:n.F}):(0,b.jsx)(v,{children:(0,b.jsx)(g.L,{})})}),(0,b.jsxs)(t,{children:[(0,b.jsx)(u,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),k&&(0,b.jsx)(f.C,{text:k,itemName:"link",color:o})]})]})}),q=e.styled.div`
  margin-top: 24px;
`,r=e.styled.div`
  display: flex;
  flex-direction: column;
...
`,v=e.styled.div`
  ...
  width: 82px;
  height: 82px;
`,w={component:()=>{let{lastScreen:a,navigateBack:d,data:e}=(0,l.a)(),f=(0,j.u)(),{requestFarcasterSignerStatus:g,closePrivyModal:h}=(0,k.u)(),[i,m]=(0,c.useState)(void 0),[n,o]=(0,c.useState)(!1),[q,r]=(0,c.useState)(!1),s=(0,c.useRef)([]),t=e?.farcasterSigner;(0,c.useEffect)(()=>{let a=Date.now(),b=setInterval(async()=>{if(!t?.public_key)return clearInterval(b),void m({retryable:!0,message:"Connect failed",detail:"Something went wrong. Please try again."});"approved"===t.status&&(clearInterval(b),o(!1),r(!0),s.current.push(setTimeout(()=>h({shouldCallAuthOnSuccess:!1,isSuccess:!0}),j.q)));let c=await g(t?.public_key),d=Date.now()-a;"approved"===c.status?(clearInterval(b),o(!1),r(!0),s.current.push(setTimeout(()=>h({shouldCallAuthOnSuccess:!1,isSuccess:!0}),j.q))):d>3e5?(clearInterval(b),m({retryable:!0,message:"Connect failed",detail:"The request timed out. Try again."})):"revoked"===c.status&&(clearInterval(b),m({retryable:!0,message:"Request rejected",detail:"The request was rejected. Please try again."}))},2e3);return()=>{clearInterval(b),s.current.forEach(a=>clearTimeout(a))}},[]);let u="pending_approval"===t?.status?t.signer_approval_url:void 0;return(0,b.jsx)(p,{appName:f.name,loading:n,success:q,errorMessage:i,connectUri:u,onBack:a?d:void 0,onClose:h,onOpenFarcaster:()=>{u&&(window.location.href=u)}})}};a.s(["FarcasterSignerStatusScreen",()=>w,"FarcasterSignerStatusView",()=>p,"default",()=>w])}];

//# sourceMappingURL=152a7_%40privy-io_react-auth_dist_esm_715982f7._.js.map