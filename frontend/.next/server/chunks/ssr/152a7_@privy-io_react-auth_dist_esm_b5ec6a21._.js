...
`;a.s(["S",()=>u])},977538,a=>{"use strict";var b=a.i(352844),c=a.i(463080),d=a.i(855672);let e=({primaryCta:a,secondaryCta:e,helpText:f,watermark:g=!0,children:h,...i})=>{let j=a||e?(0,b.jsxs)(b.Fragment,{children:[a&&(()=>{let{label:d,...e}=a,f=e.variant||"primary";return(0,b.jsx)(c.a,{...e,variant:f,style:{width:"100%",...e.style},children:d})})(),e&&(()=>{let{label:a,...d}=e,f=d.variant||"secondary";return(0,b.jsx)(c.a,{...d,variant:f,style:{width:"100%",...d.style},children:a})})()]}):null;return(0,b.jsxs)(d.S,{id:i.id,className:i.className,children:[(0,b.jsx)(d.S.Header,{...i}),h?(0,b.jsx)(d.S.Body,{children:h}):null,f||j||g?(0,b.jsxs)(d.S.Footer,{children:[f?(0,b.jsx)(d.S.HelpText,{children:f}):null,j?(0,b.jsx)(d.S.Actions,{children:j}):null,g?(0,b.jsx)(d.S.Watermark,{}):null]}):null]})};a.s(["S",()=>e])},220950,a=>{"use strict";var b=a.i(228720);let c=(a,c)=>(0,b.s)(a,c.ethereum.createOnLogin)||(0,b.k)(a,c.solana.createOnLogin);a.s(["s",()=>c])},34176,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(228720),f=a.i(375761),g=a.i(487536),h=a.i(400863),i=a.i(220950),j=a.i(977538);a.i(721594),a.i(147775),a.i(534286),a.i(158638),a.i(463893);let k=({providerApp:a,success:d,error:e,onClose:f})=>{let{title:g,subtitle:h}=(0,c.useMemo)(()=>d?{title:`Successfully connected with ${a.name}`,subtitle:"You're good to go!"}:e?{title:"Authentication failed",subtitle:e.message}:{title:`Connecting to ${a.name}`,subtitle:`Please check the pop-up from ${a.name} to continue`},[d,e,a.name]);return(0,b.jsx)(j.S,{title:g,subtitle:h,icon:a.logoUrl,iconVariant:"loading",iconLoadingStatus:{success:d,fail:!!e},onBack:f,watermark:!0})},l={component:()=>{let a=(0,d.u)(),{data:j,navigate:l,setModalData:m,onUserCloseViaDialogOrKeybindRef:n}=(0,g.a)(),{crossAppAuthFlow:o,updateWallets:p,closePrivyModal:q,createAnalyticsEvent:r}=(0,f.u)(),{logout:s}=(0,h.z)(),[t,u]=(0,c.useState)({}),v=j?.crossAppAuth,w=new f.a(`There was an issue connecting your ${v?.name} account. Please try again.`),x=new e.R(async a=>{if(v?.popup)try{let b=await o({appId:a,popup:v.popup,action:v.action,disableSignup:v.disableSignup});u({data:b})}catch(a){if(a instanceof f.a)u({error:a});else if(a instanceof f.e){if(a.privyErrorCode===f.b.ACCOUNT_TRANSFER_REQUIRED&&a.data?.data?.nonce)return m({accountTransfer:{nonce:a.data?.data?.nonce,account:a.data?.data?.subject,displayName:a.data?.data?.account?.displayName,linkMethod:`privy:${v.appId}`,embeddedWalletAddress:a.data?.data?.otherUser?.embeddedWalletAddress,oAuthUserInfo:a.data?.data?.otherUser?.oAuthUserInfo}}),void l("LinkConflictScreen");v.popup&&v.popup.close(),u({error:w})}else u({error:w})}else u({error:w})}),y=()=>{t.data&&(p(),v?.onSuccess(t.data),q({shouldCallAuthOnSuccess:!0,isSuccess:!0})),v?.onError(t.error??new f.a("User canceled flow")),q({shouldCallAuthOnSuccess:!1,isSuccess:!1})};return n.current=y,(0,c.useEffect)(()=>{v?.appId?.length&&x.execute(v.appId)},[v?.appId]),(0,c.useEffect)(()=>{if(!t.data)return;let b=t.data;if(a.legal.requireUsersAcceptTerms&&!b.hasAcceptedTerms){let a=setTimeout(()=>{l("AffirmativeConsentScreen")},d.q);return()=>clearTimeout(a)}if((0,i.s)(b,a.embeddedWallets)){let a=setTimeout(()=>{m({createWallet:{onSuccess:()=>{},onFailure:a=>{console.error(a),r({eventName:"embedded_wallet_creation_failure_logout",payload:{error:a,provider:`privy:${v?.appId}`,screen:"CrossAppAuthScreen"}}),s()},callAuthOnSuccessOnClose:!0}}),l("EmbeddedWalletOnAccountCreateScreen")},d.q);return()=>clearTimeout(a)}let c=setTimeout(y,d.q);return()=>clearTimeout(c)},[t.data]),v?.appId?(0,b.jsx)(k,{providerApp:{id:v?.appId,logoUrl:v?.logoUrl,name:v?.name},success:!!t.data,error:t.error,onClose:y}):(console.warn("Missing data for Screen"),null)},isShownBeforeReady:!0};a.s(["CrossAppAuthScreen",()=>l,"CrossAppAuthScreenView",()=>k,"default",()=>l])}];

//# sourceMappingURL=152a7_%40privy-io_react-auth_dist_esm_b5ec6a21._.js.map