...
`;a.s(["E",()=>e,"I",()=>g,"a",()=>f])},260350,a=>{"use strict";var b=a.i(352844);let c=({...a})=>(0,b.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",...a,children:[(0,b.jsx)("rect",{width:"18",height:"18",x:"3",y:"3",rx:"2"}),(0,b.jsx)("path",{d:"M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2"}),(0,b.jsx)("path",{d:"M3 11h3c.8 0 1.6.3 2.1.9l1.1.9c1.6 1.6 4.1 1.6 5.7 0l1.1-.9c.5-.5 1.3-.9 2.1-.9H21"})]});a.s(["W",()=>c])},858319,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(375761),f=a.i(541242),g=a.i(487536),h=a.i(535812);a.i(721594),a.i(534286),a.i(147775),a.i(513929);let i={component:()=>{let{setWalletConnectionStatus:a,closePrivyModal:i,inProgressAuthFlowRef:j}=(0,e.u)(),{data:k,navigate:l}=(0,g.a)(),m=(0,d.u)(),n=(0,f.a)(),o=k?.externalConnectWallet?.description,p=(0,c.useRef)(k?.externalConnectWallet?.walletList??m.appearance.walletList),q=(0,c.useRef)(k?.externalConnectWallet?.walletChainType??m.appearance.walletChainType),r=p.current,s=q.current,t="link"===j.current?void 0:()=>l("LandingScreen");return(0,b.jsx)(h.i,{walletList:r,walletChainType:s,onClose:i,onConnect:(0,c.useCallback)(({connector:b,wallet:c})=>{n("connectWallet","onSuccess",{wallet:c}),a({status:"connected",connectedWallet:c,connector:b,connectError:null,connectRetry:()=>null}),l("ConnectionStatusScreen",!k?.externalConnectWallet?.preSelectedWalletId)},[a,l,k?.login?.disableSignup,k?.externalConnectWallet?.preSelectedWalletId]),onConnectError:a=>{a instanceof e.c?(console.warn(a.cause?a.cause:a.message),n("connectWallet","onError",a.privyErrorCode||e.b.GENERIC_CONNECT_WALLET_ERROR)):(console.warn(a),n("connectWallet","onError",e.b.UNKNOWN_CONNECT_WALLET_ERROR))},onBack:t,customDescription:o||"",preSelectedWalletId:k?.externalConnectWallet?.preSelectedWalletId,app:m})},isUnauthenticatedScreem:!0};a.s(["AuthenticateWithWalletScreen",()=>i,"default",()=>i])}];

//# sourceMappingURL=152a7_%40privy-io_react-auth_dist_esm_4f9a5ffa._.js.map