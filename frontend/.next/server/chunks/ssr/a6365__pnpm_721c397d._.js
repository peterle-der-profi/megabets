...
`,f=b.styled.span`
  ...
  ${c.L}
`;a.s(["L",()=>d,"V",()=>f,"a",()=>e])},122281,a=>{"use strict";var b=a.i(126520);let c=b.styled.span`
  color: var(--privy-color-foreground);
  font-size: 1.125rem;
  font-weight: 600;
...
`,g=d.styled.div`
  ...
  flex: 1;
  text-align: left;
`;a.s(["E",()=>e])},626296,a=>{"use strict";var b=a.i(352844),c=a.i(337020),d=a.i(124649),e=a.i(42783),f=a.i(126520),g=a.i(463080),h=a.i(973949),i=a.i(308913),j=a.i(374855),k=a.i(993355);let l=(0,f.styled)(k.B)`
  && {
    padding: 0.75rem;
    height: 56px;
  }
