...
`,f=b.styled.span`
  ...
  ${c.L}
`;a.s(["L",()=>d,"V",()=>f,"a",()=>e])},556019,a=>{"use strict";let b=2n**256n-1n,c=({amount:a,decimals:c})=>a===b?"Maximum":Intl.NumberFormat(void 0,{maximumFractionDigits:c}).format(Number(a)/10**c);a.s(["f",()=>c])},717727,a=>{"use strict";let b=[{constant:!1,inputs:[{name:"_to",type:"address"},{name:"_value",type:"uint256"}],name:"transfer",outputs:[{name:"",type:"bool"}],payable:!1,stateMutability:"nonpayable",type:"function"}],c=[{constant:!1,inputs:[{name:"_to",type:"address"},{name:"_value",type:"uint256"}],name:"transfer",outputs:[],payable:!1,stateMutability:"nonpayable",type:"function"}];a.s(["E",()=>b,"a",()=>c])},959521,a=>{"use strict";var b=a.i(352844),c=a.i(273932),d=a.i(42783),e=a.i(573334),f=a.i(345945),g=a.i(893202),h=a.i(156838),i=a.i(688039),j=a.i(945113),k=a.i(814960),l=a.i(926936),m=a.i(703295),n=a.i(30960),o=a.i(463080),p=a.i(3785),q=a.i(580254),r=a.i(452475),s=a.i(847920),t=a.i(375761),u=a.i(400863),v=a.i(487536),w=a.i(459177),x=a.i(269299),y=a.i(717727),z=a.i(556019),A=a.i(194712),B=a.i(17963),C=a.i(299776),D=a.i(228720),E=a.i(424186),F=a.i(425545),G=a.i(619992),H=a.i(718963);a.i(721594),a.i(534286),a.i(147775),a.i(158638),a.i(463893);let I={component:()=>{let{rpcConfig:a,appId:I,closePrivyModal:J,createAnalyticsEvent:K}=(0,t.u)(),{navigate:L,setModalData:M,data:N}=(0,v.a)(),O=(0,s.u)(),{wallets:P}=(0,x.u)(),[Q,R]=(0,d.useState)(!1),[S,T]=(0,d.useState)(0n),[U,V]=(0,d.useState)(!1),[W,X]=(0,d.useState)(null),[Y,Z]=(0,d.useState)(null),[$,_]=(0,d.useState)([]),[aa,ab]=(0,d.useState)(0),[ac,ad]=(0,d.useState)(!1),[ae,af]=(0,d.useState)(!1),[ag,ah]=(0,d.useState)(!1),[ai,aj]=(0,d.useState)(!1),[ak,al]=(0,d.useState)(),[am,an]=(0,d.useState)();if(!N?.funding||"ethereum"!==N.funding.chainType)throw Error("Invalid funding data");let{erc20ContractInfo:ao,chain:ap,connectedWallet:aq}=N.funding,ar=N.funding.address,as=N.funding.erc20Address,[at,au]=(0,d.useState)(N.funding.amount);(0,d.useEffect)(()=>{as&&!ao&&X(Error("Unable to fetch token details"))},[]);let av=!!as&&!!ao,aw=av?BigInt(parseFloat(at)*10**ao.decimals):(0,e.parseEther)(at),ax=("ethereum"===aq?.type?aq:void 0)??P[0],ay=(0,u.Q)(ax?.walletClientType||"unknown"),az=ay?.name||"wallet",[aA,aB]=(0,d.useState)(null);(0,d.useEffect)(()=>{(async()=>{if(!ax)return;let a=await ax.getEthereumProvider();aB((0,f.createWalletClient)({account:ax.address,transport:(0,g.custom)(a)}).extend(h.publicActions))})().catch(console.error)},[ax]);let[aC,aD]=(0,d.useState)(0n);(0,d.useEffect)(()=>{(0,i.createPublicClient)({chain:ap,transport:(0,j.http)((0,G.a)(ap,a,I))}).getBalance({address:ar}).then(aD).catch(console.error)},[]);let[aE,aF]=(0,d.useState)(0n);(0,d.useEffect)(()=>{av&&(0,F.g)({chain:ap,address:ar,appId:I,rpcConfig:a,erc20Address:as}).then(a=>aF(a.balance)).catch(console.error)},[]);let{tokenPrice:aG}=(0,w.u)(ap.id),[aH,aI]=(0,d.useState)({to:ar,chain:ap,value:aw,data:void 0});(0,d.useEffect)(()=>{(async()=>{let b,c;if(!aA||!ax||ac||ag)return;ad(!0);let d=(0,i.createPublicClient)({chain:aH.chain,transport:(0,j.http)((0,G.a)(aH.chain,a,I))});if(av&&!aH.data)return await d.simulateContract({address:as,chain:aH.chain,abi:y.E,functionName:"transfer",args:[ar,aw],account:ax.address}).catch(a=>{if("ContractFunctionZeroDataError"===a?.cause?.name||a?.message?.includes("returned no data"))return d.simulateContract({address:as,chain:aH.chain,abi:y.a,functionName:"transfer",args:[ar,aw],account:ax.address}).catch(a=>{console.warn("Simulated token transfer failed with error, fetching bridge options.",a)});console.warn("Simulated token transfer failed with error, fetching bridge options.",a)})?(ad(!1),void aI({to:as,chain:aH.chain,data:(0,k.encodeFunctionData)({abi:y.E,functionName:"transfer",args:[ar,aw]}),value:"0x0"})):(ad(!1),void V(!0));try{b=await d.prepareTransactionRequest({account:ax.address,to:aH.to,chain:aH.chain,data:aH.data,value:BigInt(aH.value??0)})}catch(a){if(console.error(a),$.length>1)Z(a.shortMessage??"Something went wrong");else if(ae&&0===$.length)return void X(new t.a(`Wallet ${(0,u.D)(ax.address)} does not have enough funds.`,void 0,t.b.INSUFFICIENT_BALANCE))}if(!b)return ad(!1),void V(!0);ad(!1),ah(!0),R(!0),T(b.gas);try{await aA.switchChain({id:aH.chain.id})}catch(a){await aA.addChain({chain:aH.chain}),await aA.switchChain({id:aH.chain.id})}try{c=await aA.sendTransaction(b)}catch(a){if(console.error(a),"TransactionExecutionError"===a.name)if($.length<1){let b=a.shortMessage;(a.shortMessage.includes("rejected the request")||a.details.includes("rejected the request"))&&(b="User rejected the request."),X(new t.a(b,void 0,t.b.TRANSACTION_FAILURE))}else Z(a.shortMessage??"Something went wrong")}c?(await aA.waitForTransactionReceipt({hash:c}),ah(!1),ae?(al(c),an("pending")):(aj(!0),M((0,D.y)(N,"completed",c,ax?.walletClientType,av,ao,ap)),K({eventName:B.O,payload:{provider:"external",status:"success",txHash:c,address:ax.address,chainId:aH.chain.id,chainType:"ethereum",value:aH.value?(0,l.formatUnits)(BigInt(aH.value),ao?.decimals??18):void 0,token:ao?.symbol??as??"ETH",destinationAddress:ar,destinationChainId:ap.id,destinationChainType:"ethereum",destinationValue:aw?(0,l.formatUnits)(aw,ao?.decimals??18):void 0,destinationToken:ao?.symbol??as??ap.nativeCurrency.name}}))):ah(!1)})().catch(console.error)},[aA,aH]),(0,d.useEffect)(()=>{(async()=>{if(!U||!aA||!ax)return;let b=(0,m.addToDefaultChains)(O.chains).filter(a=>a.id!==ap.id&&!!a.testnet==!!ap.testnet);av&&b.unshift(ap);let c=await (0,E.g)({chains:b,address:ax.address,appId:I,rpcConfig:a,includeUsdc:N.funding?.isUSDC}),d=av?c.filter(a=>a.balance>0n):c.filter(a=>a.balance>aw),e=av&&c.every(a=>0n===a.balance);if(d.length<1)return void X(new t.a(e?`Wallet ${(0,u.D)(ax.address)} doesn't have enough funds to cover gas fees. Top up your wallet and try again.`:`Wallet ${(0,u.D)(ax.address)} does not have enough funds.`,void 0,t.b.INSUFFICIENT_BALANCE));d.sort((a,b)=>Number(av?(b.erc20Balance??0n)-(a.erc20Balance??0n):b.balance-a.balance));let f=d.flatMap(a=>{let b=[{...a,isErc20Quote:!1,isTestnet:!!ap.testnet,input:(0,C.t)({appId:I,amount:aw.toString(),user:ax.address,recipient:ar,destinationChainId:ap.id,destinationCurrency:as,originChainId:a.chain.id})}];return av&&as&&(a.erc20Balance??0n)>=aw&&b.push({...a,isErc20Quote:!0,isTestnet:!!ap.testnet,input:(0,C.t)({appId:I,amount:aw.toString(),user:ax.address,recipient:ar,destinationChainId:ap.id,destinationCurrency:as,originChainId:a.chain.id,originCurrency:a.erc20Address})}),b}),g=(await Promise.allSettled(f.map(async a=>({...a,quote:await (0,C.g)(a)})))).filter(a=>"fulfilled"===a.status).map(a=>a.value);if(g.length<1)return void X(new t.a(`Wallet ${(0,u.D)(ax.address)} does not have enough funds.`,void 0,t.b.INSUFFICIENT_BALANCE));let h=g.map(a=>({bridgeTx:(0,C.c)(a.quote),balance:a.balance,chain:a.chain,erc20Balance:a.erc20Balance,isErc20Quote:a.isErc20Quote})).filter(a=>!!a.bridgeTx);if(h.length>1)return void _(h);let i=h[0];i?(af(!0),aI({data:i.bridgeTx.data,to:i.bridgeTx.to,value:i.bridgeTx.value,chain:i.chain})):X(new t.a(`Wallet ${(0,u.D)(ax.address)} does not have enough funds.`,void 0,t.b.INSUFFICIENT_BALANCE))})().catch(console.error)},[U]),(0,C.u)({transactionHash:ak,isTestnet:!!ap.testnet,bridgingStatus:am,setBridgingStatus:an,onSuccess({transactionHash:a}){af(!1),aj(!0),M((0,D.y)(N,"completed",a,ax?.walletClientType,av,ao,ap)),K({eventName:B.O,payload:{provider:"external",status:"success",txHash:a,address:ax?.address,chainId:aH.chain.id,chainType:"ethereum",value:aH.value?(0,l.formatUnits)(BigInt(aH.value),ao?.decimals??18):void 0,token:ao?.symbol??as??"ETH",destinationAddress:ar,destinationChainId:ap.id,destinationChainType:"ethereum",destinationValue:aw?(0,l.formatUnits)(aw,ao?.decimals??18):void 0,destinationToken:ao?.symbol??as??ap.nativeCurrency.name}})},onFailure({error:a}){af(!1),X(a)}}),(0,d.useEffect)(()=>{W&&(M({funding:N?.funding,solanaFundingData:N?.solanaFundingData,sendTransaction:N?.sendTransaction,errorModalData:{error:W,previousScreen:"TransferFromWalletScreen"}}),L("ErrorScreen",!1))},[W]);let aJ=!av&&aG?(0,A.c)(at??"0",aG):void 0,aK=av?S:(0,A.s)([S,aw]),aL=aK&&aG?(0,A.a)(aK,aG):void 0,aM=aK?(0,A.g)(aK,N?.funding?.erc20Address?N?.funding?.erc20ContractInfo?.symbol||"ETH":N?.funding?.chain.nativeCurrency.symbol||"ETH"):void 0,aN=S&&aG?(0,A.a)(S,aG):void 0,aO=S?(0,A.g)(S,ap?.nativeCurrency?.symbol||"ETH"):void 0;if((0,d.useEffect)(()=>{if(!ai)return;let a=setTimeout(J,s.t);return()=>clearTimeout(a)},[ai]),ai)return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(q.t,{}),(0,b.jsx)(n.b,{}),(0,b.jsxs)(n.c,{children:[(0,b.jsx)(c.default,{color:"var(--privy-color-success)",width:"64px",height:"64px"}),(0,b.jsx)(p.C,{title:"Success!",description:`You’ve successfully added ${at} ${av?ao.symbol:ap.nativeCurrency.symbol} to your ${O.name} wallet. It may take a minute before the funds are available to use.`})]}),(0,b.jsx)(n.R,{}),(0,b.jsx)(o.B,{})]});let aP=av?`${(0,z.f)({amount:aE,decimals:ao.decimals})}  ${ao.symbol}`:(0,A.g)(aC,ap.nativeCurrency.symbol,3,!0),aQ=$[aa];return $.length>1&&aQ?(0,b.jsx)(E.B,{displayName:az,configuredFundingChain:ap,erc20ContractInfo:ao,formattedBalance:aP,fundingAmount:at,fundingCurrency:av?ao.symbol:ap.nativeCurrency.symbol,fundingAmountInUsd:aJ,options:$,selectedOption:aQ,isPreparing:ac,isSubmitting:ag,addressToFund:ar,fundingWalletAddress:ax?.address||"",errorMessage:Y,onSubmit:()=>{N.funding?.amount!==at?(async function(){if(ax&&aQ)try{let a=await (0,C.g)({isTestnet:!!ap.testnet,input:(0,C.t)({appId:I,amount:aw.toString(),user:ax.address,recipient:ar,destinationChainId:ap.id,destinationCurrency:as,originChainId:aQ.chain.id})}),b=(0,C.c)(a);if(!b)throw Error("Invalid transaction request");af(!0),aI({data:b.data,to:b.to,value:b.value,chain:aQ.chain})}catch(a){console.error(a),X(new t.a("Unable to fetch quotes for bridging",a,t.b.INSUFFICIENT_BALANCE))}})().catch(console.error):aI({to:aQ.bridgeTx.to,data:aQ.bridgeTx.data,value:aQ.bridgeTx.value,chain:aQ.chain})},onSelect:a=>{a!==aa&&(Z(null),ab(a))},onAmountChange:au}):Q&&S&&ax&&N?.funding?(0,b.jsx)(H.T,{walletClientType:ax?.walletClientType||"unknown",displayName:az,addressToFund:ar,isBridging:ae,isErc20Flow:av,totalPriceInUsd:aL,totalPriceInNativeCurrency:aM,gasPriceInUsd:aN,gasPriceInNativeCurrency:aO,chainId:ap.id,chainName:ap.name}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(q.t,{}),(0,b.jsx)(r.N,{}),(0,b.jsx)("div",{style:{marginTop:"1rem"}}),(0,b.jsx)(o.B,{})]})}};a.s(["AwaitingExternalEthereumTransferScreen",()=>I,"default",()=>I])}];

//# sourceMappingURL=a6365__pnpm_190772f8._.js.map