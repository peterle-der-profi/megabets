...
`;a.s(["A",()=>g,"B",()=>n,"C",()=>j,"E",()=>x,"F",()=>y,"I",()=>w,"L",()=>k,"M",()=>o,"N",()=>E,"P",()=>v,"R",()=>q,"S",()=>i,"T",()=>h,"a",()=>u,"b",()=>m,"c",()=>l,"d",()=>p,"e",()=>t,"f",()=>r,"g",()=>s],917302)},124303,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(487536),f=a.i(864181);a.i(721594),a.i(534286),a.i(147775),a.i(158638),a.i(463893);let g={component:()=>{let{user:a}=(0,e.u)(),g=(0,d.u)(),h=(0,c.useMemo)(()=>a?.mfaMethods.filter(a=>"passkey"!==a||!g.globalDisablePasskeys)??[],[a?.mfaMethods,g.globalDisablePasskeys]),{data:i}=(0,e.a)(),[j,k]=(0,c.useState)(h[0]),[l,m]=(0,c.useState)(!1),[n,o]=(0,c.useState)(),[p,q]=(0,c.useState)();if((0,c.useEffect)(()=>{k(h[0])},[h]),!i?.mfaVerify)throw Error("Missing modal data for MFA verification screen.");let{onFailure:r,onSuccess:s,generateOptions:t,verifyTotpCode:u,verifyPasskey:v,verifySmsCode:w,sendSmsCode:x}=i.mfaVerify,y=async a=>{if("passkey"!==a)try{k(a),"sms"===a&&(k(a),await x()),"totp"===a&&k(a)}catch(a){console.error(a)}else try{k(a);let b=await t();if(!b)throw Error("something went wrong");o(b),await v(b),m(!0),q(void 0),s()}catch(a){q((0,f.t)(a))}},z=async a=>{q(void 0);try{if(!a||!j)return;if("passkey"===j){if(!n)throw Error("Missing passkey challenge");await v(n)}else"sms"===j?await w(a):"totp"===j&&await u(a);q(void 0),m(!0),s()}catch(a){throw(0,f.t)(a).error}},A=()=>{p||!l?r(p?.error??Error("Canceled MFA verification.")):s()},B=(0,c.useRef)(!1);return(0,c.useEffect)(()=>{!B.current&&j&&(B.current=!0,y(j).finally(()=>{B.current=!1}))},[open]),a?"passkey"===j?(0,b.jsx)(f.V,{account:a.linkedAccounts.filter(a=>"passkey"===a.type&&a.enrolledInMfa).sort((a,b)=>b.firstVerifiedAt.valueOf()-a.firstVerifiedAt.valueOf())[0],submitSuccess:l,hasBlockingError:p?.isBlocking??!1,error:p?.error,onClose:A,onBack:()=>{k(void 0),q(void 0)},handleSubmit:()=>z(n).catch(q)}):"sms"===j||"totp"===j?(0,b.jsx)(f.a,{selectedMethod:j,submitSuccess:l,hasBlockingError:p?.isBlocking??!1,handleSubmitCode:z,onClose:A,onBack:h.length>1?()=>k(void 0):void 0}):(0,b.jsx)(f.b,{mfaMethods:h,onSelect:y,handleClose:A}):null}};a.s(["MfaAuthVerifyFlowScreen",()=>g,"default",()=>g])}];

//# sourceMappingURL=a6365__pnpm_a3f5ac75._.js.map