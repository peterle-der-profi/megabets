...
`;a.s(["A",()=>i])},413165,a=>{"use strict";let b=(0,a.i(489252).default)("circle-alert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);a.s(["AlertCircle",()=>b],413165)},625113,a=>{"use strict";var b=a.i(352844),c=a.i(413165),d=a.i(269554);let e=(0,a.i(489252).default)("cloud-upload",[["path",{d:"M12 13v8",key:"1l5pq0"}],["path",{d:"M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242",key:"1pljnt"}],["path",{d:"m8 17 4-4 4 4",key:"1quai1"}]]);var f=a.i(42783),g=a.i(626296),h=a.i(847920),i=a.i(375761),j=a.i(487536),k=a.i(977538);a.i(534286),a.i(147775),a.i(721594);let l=({appName:a,address:f,success:h,error:i,onAccept:j,onDecline:l,onClose:m})=>(0,b.jsx)(k.S,h||i?{title:i?"Something went wrong":"Success!",subtitle:i?"Please try again.":`You've successfully granted delegated action permissions to ${a}.`,icon:i?c.AlertCircle:d.CheckCircle,iconVariant:i?"error":"success",onBack:m,watermark:!0}:{title:"Enable offline access",subtitle:`By confirming, ${a} will be able to use your wallet for you even when you're not around. You can revoke this later.`,icon:e,primaryCta:{label:"Accept",onClick:j},secondaryCta:{label:"Not now",onClick:l},onBack:m,watermark:!0,children:(0,b.jsx)(g.W,{address:f,title:"Wallet"})}),m={component:()=>{let{data:a}=(0,j.a)(),c=(0,h.u)(),{closePrivyModal:d}=(0,i.u)(),[e,g]=(0,f.useState)(!1),[k,m]=(0,f.useState)(),{address:n,onDelegate:o,onSuccess:p,onError:q}=a.delegatedActions.consent,r=async()=>{e?p():q(k??new i.a("User declined delegating actions.")),d({shouldCallAuthOnSuccess:!1})};return(0,f.useEffect)(()=>{if(!e&&!k)return;let a=setTimeout(r,h.r);return()=>clearTimeout(a)},[e,k]),(0,b.jsx)(l,{appName:c.name,address:n,success:e,error:k,onAccept:async()=>{try{await o(),g(!0)}catch(a){m(a)}},onDecline:()=>{r()},onClose:r})}};a.s(["DelegatedActionsConsentScreen",()=>m,"DelegatedActionsConsentScreenView",()=>l,"default",()=>m],625113)}];

//# sourceMappingURL=a6365__pnpm_dd76344d._.js.map