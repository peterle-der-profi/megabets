...
`;a.s(["S",()=>u])},977538,a=>{"use strict";var b=a.i(352844),c=a.i(463080),d=a.i(855672);let e=({primaryCta:a,secondaryCta:e,helpText:f,watermark:g=!0,children:h,...i})=>{let j=a||e?(0,b.jsxs)(b.Fragment,{children:[a&&(()=>{let{label:d,...e}=a,f=e.variant||"primary";return(0,b.jsx)(c.a,{...e,variant:f,style:{width:"100%",...e.style},children:d})})(),e&&(()=>{let{label:a,...d}=e,f=d.variant||"secondary";return(0,b.jsx)(c.a,{...d,variant:f,style:{width:"100%",...d.style},children:a})})()]}):null;return(0,b.jsxs)(d.S,{id:i.id,className:i.className,children:[(0,b.jsx)(d.S.Header,{...i}),h?(0,b.jsx)(d.S.Body,{children:h}):null,f||j||g?(0,b.jsxs)(d.S.Footer,{children:[f?(0,b.jsx)(d.S.HelpText,{children:f}):null,j?(0,b.jsx)(d.S.Actions,{children:j}):null,g?(0,b.jsx)(d.S.Watermark,{}):null]}):null]})};a.s(["S",()=>e])},220950,a=>{"use strict";var b=a.i(228720);let c=(a,c)=>(0,b.s)(a,c.ethereum.createOnLogin)||(0,b.k)(a,c.solana.createOnLogin);a.s(["s",()=>c])},912002,a=>{"use strict";var b=a.i(352844);function c(a){return(0,b.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",...a,children:[(0,b.jsx)("rect",{width:"512",height:"512",rx:"15%",fill:"#37aee2"}),(0,b.jsx)("path",{fill:"#c8daea",d:"M199 404c-11 0-10-4-13-14l-32-105 245-144"}),(0,b.jsx)("path",{fill:"#a9c9dd",d:"M199 404c7 0 11-4 16-8l45-43-56-34"}),(0,b.jsx)("path",{fill:"#f6fbfe",d:"M204 319l135 99c14 9 26 4 30-14l55-258c5-22-9-32-24-25L79 245c-21 8-21 21-4 26l83 26 190-121c9-5 17-3 11 4"})]})}a.s(["T",()=>c])},800186,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(228720),e=a.i(847920),f=a.i(375761),g=a.i(487536),h=a.i(220950),i=a.i(977538),j=a.i(912002);a.i(147775),a.i(534286),a.i(158638),a.i(463893),a.i(721594);let k=({success:a,errorMessage:c,onRetry:d})=>{let e=a?"Successfully connected with Telegram":c?c.message:"Verifying connection to Telegram";return(0,b.jsx)(i.S,{title:e,subtitle:a?"You're good to go!":c?c.detail:"Just a few moments more",icon:j.T,iconVariant:"loading",iconLoadingStatus:{success:a,fail:!!c},secondaryCta:c?.retryable&&d?{label:"Retry",onClick:d}:void 0,watermark:!0})},l={component:()=>{let{authenticated:a,logout:i,ready:j,user:l}=(0,g.u)(),{setModalData:m,navigate:n,resetNavigation:o,data:p}=(0,g.a)(),q=(0,e.u)(),{initLoginWithTelegram:r,loginWithTelegram:s,updateWallets:t,setReadyToTrue:u,closePrivyModal:v,createAnalyticsEvent:w,getAuthMeta:x}=(0,f.u)(),[y,z]=(0,c.useState)(!1),[A,B]=(0,c.useState)(void 0),C=(0,d.a)();async function D(){try{let b=await async function(){let b;if(!a){if(C.enabled&&"error"===C.status)throw new d.C(C.error,null,f.b.CAPTCHA_FAILURE);return C.enabled&&"success"!==C.status&&(C.execute(),b=await C.waitForResult()),b}}();await s({captchaToken:b}),z(!0),u(!0)}catch(c){if(c?.privyErrorCode===f.b.ALLOWLIST_REJECTED)return B(void 0),o(),void n("AllowlistRejectionScreen");if(c?.privyErrorCode===f.b.USER_LIMIT_REACHED)return console.error(new f.k(c).toString()),B(void 0),o(),void n("UserLimitReachedScreen");if(c?.privyErrorCode===f.b.USER_DOES_NOT_EXIST)return B(void 0),o(),void n("AccountNotFoundScreen");if(c?.privyErrorCode===f.b.ACCOUNT_TRANSFER_REQUIRED&&c.data?.data?.nonce)return B(void 0),o(),m({accountTransfer:{nonce:c.data?.data?.nonce,account:c.data?.data?.subject,telegramAuthResult:x()?.telegramAuthResult,telegramWebAppData:x()?.telegramWebAppData,displayName:c.data?.data?.account?.displayName,linkMethod:"telegram",embeddedWalletAddress:c.data?.data?.otherUser?.embeddedWalletAddress}}),void n("LinkConflictScreen");let{retryable:a,detail:b}=(0,d.m)(c);B({retryable:a,detail:b,message:"Authentication failed"})}}return(0,c.useEffect)(()=>{D()},[]),(0,c.useEffect)(()=>{if(!(j&&a&&y&&l))return;if(q?.legal.requireUsersAcceptTerms&&!l.hasAcceptedTerms){let a=setTimeout(()=>{n("AffirmativeConsentScreen")},e.q);return()=>clearTimeout(a)}if((0,h.s)(l,q.embeddedWallets)){let a=setTimeout(()=>{m({createWallet:{onSuccess:()=>{},onFailure:a=>{console.error(a),w({eventName:"embedded_wallet_creation_failure_logout",payload:{error:a,provider:"telegram",screen:"TelegramAuthScreen"}}),i()},callAuthOnSuccessOnClose:!0}}),n("EmbeddedWalletOnAccountCreateScreen")},e.q);return()=>clearTimeout(a)}t();let b=setTimeout(()=>v({shouldCallAuthOnSuccess:!0,isSuccess:!0}),e.q);return()=>clearTimeout(b)},[j,a,y,l]),(0,b.jsx)(k,{success:y,errorMessage:A,onRetry:A?.retryable?async()=>{try{B(void 0),p?.telegramAuthModalData?.seamlessAuth||await r(void 0,p?.login?.disableSignup),await D()}catch(c){let{retryable:a,detail:b}=(0,d.m)(c);B({retryable:a,detail:b,message:"Authentication failed"})}}:void 0})},isCaptchaRequired:!0,isShownBeforeReady:!0};a.s(["TelegramAuthScreen",()=>l,"TelegramAuthScreenView",()=>k,"default",()=>l])}];

//# sourceMappingURL=152a7_%40privy-io_react-auth_dist_esm_4b37d284._.js.map