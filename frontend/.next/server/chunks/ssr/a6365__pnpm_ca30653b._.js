...
`;a.s(["S",()=>u])},30960,a=>{"use strict";var b=a.i(126520);let c=b.styled.div`
  display: flex;
  flex-direction: column;
...
`;a.s(["D",()=>q,"E",()=>j,"H",()=>v,"I",()=>t,"N",()=>k,"P",()=>o,"R",()=>u,"S",()=>w,"a",()=>m,"b",()=>p,"c",()=>i,"d",()=>r,"e",()=>x,"f",()=>n,"g",()=>s],124164)},92447,a=>{"use strict";var b=a.i(352844),c=a.i(998451),d=a.i(42783),e=a.i(126520),f=a.i(487536),g=a.i(463080),h=a.i(30960),i=a.i(124164),j=a.i(228720),k=a.i(375761),l=a.i(855672);a.i(721594),a.i(534286),a.i(147775),a.i(158638),a.i(463893);let m={component:()=>{let[a,e]=(0,d.useState)(!0),{authenticated:g,user:m}=(0,f.u)(),{walletProxy:q,closePrivyModal:r,createAnalyticsEvent:s,client:t}=(0,k.u)(),{navigate:u,data:v,onUserCloseViaDialogOrKeybindRef:w}=(0,f.a)(),[x,y]=(0,d.useState)(void 0),[z,A]=(0,d.useState)(""),[B,C]=(0,d.useState)(!1),{entropyId:D,entropyIdVerifier:E,onCompleteNavigateTo:F,onSuccess:G,onFailure:H}=v.recoverWallet,I=(a="User exited before their wallet could be recovered")=>{r({shouldCallAuthOnSuccess:!1}),H("string"==typeof a?new k.m(a):a)};return w.current=I,(0,d.useEffect)(()=>{if(!g)return I("User must be authenticated and have a Privy wallet before it can be recovered")},[g]),(0,b.jsxs)(l.S,{children:[(0,b.jsx)(l.S.Header,{icon:c.default,title:"Enter your password",subtitle:"Please provision your account on this new device. To continue, enter your recovery password.",showClose:!0,onClose:I}),(0,b.jsx)(l.S.Body,{children:(0,b.jsx)(n,{children:(0,b.jsxs)("div",{children:[(0,b.jsxs)(i.P,{children:[(0,b.jsx)(i.a,{type:a?"password":"text",onChange:a=>{var b;(b=a.target.value)&&y(b)},disabled:B,style:{paddingRight:"2.3rem"}}),(0,b.jsx)(i.I,{style:{right:"0.75rem"},children:a?(0,b.jsx)(i.H,{onClick:()=>e(!1)}):(0,b.jsx)(i.S,{onClick:()=>e(!0)})})]}),!!z&&(0,b.jsx)(o,{children:z})]})})}),(0,b.jsxs)(l.S.Footer,{children:[(0,b.jsx)(l.S.HelpText,{children:(0,b.jsxs)(h.S,{children:[(0,b.jsx)("h4",{children:"Why is this necessary?"}),(0,b.jsx)("p",{children:"You previously set a password for this wallet. This helps ensure only you can access it"})]})}),(0,b.jsx)(l.S.Actions,{children:(0,b.jsx)(p,{loading:B||!q,disabled:!x,onClick:async()=>{C(!0);let a=await t.getAccessToken(),b=(0,f.h)(m,D);if(!a||!b||null===x)return I("User must be authenticated and have a Privy wallet before it can be recovered");try{s({eventName:"embedded_wallet_recovery_started",payload:{walletAddress:b.address}}),await q?.recover({accessToken:a,entropyId:D,entropyIdVerifier:E,recoveryPassword:x}),A(""),F?u(F):r({shouldCallAuthOnSuccess:!1}),G?.(b),s({eventName:"embedded_wallet_recovery_completed",payload:{walletAddress:b.address}})}catch(a){(0,j.n)(a)?A("Invalid recovery password, please try again."):A("An error has occurred, please try again.")}finally{C(!1)}},$hideAnimations:!D&&B,children:"Recover your account"})}),(0,b.jsx)(l.S.Watermark,{})]})]})}},n=e.styled.div`
  display: flex;
  flex-direction: column;
  gap: 1.5rem;
`,o=e.styled.div`
...
`,p=(0,e.styled)(g.P)`
  ${({$hideAnimations:a})=>a&&e.css`
    ...
    `}
`;a.s(["PasswordRecoveryScreen",()=>m,"default",()=>m])}];

//# sourceMappingURL=a6365__pnpm_ca30653b._.js.map