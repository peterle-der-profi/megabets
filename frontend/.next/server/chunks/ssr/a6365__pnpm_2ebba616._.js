...
`;a.s(["A",()=>g,"B",()=>n,"C",()=>j,"E",()=>x,"F",()=>y,"I",()=>w,"L",()=>k,"M",()=>o,"N",()=>E,"P",()=>v,"R",()=>q,"S",()=>i,"T",()=>h,"a",()=>u,"b",()=>m,"c",()=>l,"d",()=>p,"e",()=>t,"f",()=>r,"g",()=>s],917302)},662410,a=>{"use strict";var b=a.i(352844),c=a.i(42783),d=a.i(847920),e=a.i(487536),f=a.i(228720),g=a.i(864181);a.i(721594),a.i(147775),a.i(534286),a.i(158638),a.i(463893);let h=({onClose:a})=>{let{user:h}=(0,e.u)(),i=(0,d.u)(),j=(0,c.useMemo)(()=>h?.mfaMethods.filter(a=>"passkey"!==a||!i.globalDisablePasskeys)??[],[h?.mfaMethods,i.globalDisablePasskeys]),[k,l]=(0,c.useState)(j[0]??null),{init:m,cancel:n,submit:o}=(0,f.u)(),[p,q]=(0,c.useState)(!1),[r,s]=(0,c.useState)(null),[t,u]=(0,c.useState)();(0,c.useEffect)(()=>{l(j[0]??null)},[j]);let v=(0,c.useRef)(!1);async function w(b){u(void 0);try{if(!b||!k)return;await o(k,b),q(!0),u(void 0),a()}catch(a){throw(0,g.t)(a).error}}async function x(b){if("passkey"!==b)try{l(b),await m(b)}catch(a){console.error(a)}else try{l(b);let c=await m(b);if(!c)throw Error("something went wrong");s(c),await o(b,c),q(!0),u(void 0),a()}catch(a){u((0,g.t)(a))}}(0,c.useEffect)(()=>{!v.current&&k&&(v.current=!0,x(k).finally(()=>{v.current=!1}))},[]);let y=()=>{l(null),u(void 0),n(),a()};return h?"passkey"===k?(0,b.jsx)(g.V,{account:h.linkedAccounts.filter(a=>"passkey"===a.type&&a.enrolledInMfa).sort((a,b)=>b.firstVerifiedAt.valueOf()-a.firstVerifiedAt.valueOf())[0],submitSuccess:p,hasBlockingError:t?.isBlocking??!1,error:t?.error,onClose:y,onBack:()=>{l(null),u(void 0)},handleSubmit:()=>w(r).catch(u)}):k?(0,b.jsx)(g.a,{submitSuccess:p,hasBlockingError:t?.isBlocking??!1,handleSubmitCode:w,selectedMethod:k,onClose:y,onBack:j.length>1?()=>l(null):void 0}):(0,b.jsx)(g.b,{mfaMethods:j,onSelect:x,handleClose:y}):null};a.s(["MfaVerifyFlowScreen",()=>h,"default",()=>h])}];

//# sourceMappingURL=a6365__pnpm_2ebba616._.js.map