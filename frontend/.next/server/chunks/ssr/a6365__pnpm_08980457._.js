...
`;a.s(["S",()=>u])},977538,a=>{"use strict";var b=a.i(352844),c=a.i(463080),d=a.i(855672);let e=({primaryCta:a,secondaryCta:e,helpText:f,watermark:g=!0,children:h,...i})=>{let j=a||e?(0,b.jsxs)(b.Fragment,{children:[a&&(()=>{let{label:d,...e}=a,f=e.variant||"primary";return(0,b.jsx)(c.a,{...e,variant:f,style:{width:"100%",...e.style},children:d})})(),e&&(()=>{let{label:a,...d}=e,f=d.variant||"secondary";return(0,b.jsx)(c.a,{...d,variant:f,style:{width:"100%",...d.style},children:a})})()]}):null;return(0,b.jsxs)(d.S,{id:i.id,className:i.className,children:[(0,b.jsx)(d.S.Header,{...i}),h?(0,b.jsx)(d.S.Body,{children:h}):null,f||j||g?(0,b.jsxs)(d.S.Footer,{children:[f?(0,b.jsx)(d.S.HelpText,{children:f}):null,j?(0,b.jsx)(d.S.Actions,{children:j}):null,g?(0,b.jsx)(d.S.Watermark,{}):null]}):null]})};a.s(["S",()=>e])},489252,a=>{"use strict";var b=a.i(42783);let c=a=>{let b=a.replace(/^([A-Z])|[\s-_]+(\w)/g,(a,b,c)=>c?c.toUpperCase():b.toLowerCase());return b.charAt(0).toUpperCase()+b.slice(1)},d=(...a)=>a.filter((a,b,c)=>!!a&&""!==a.trim()&&c.indexOf(a)===b).join(" ").trim();var e={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};let f=(0,b.forwardRef)(({color:a="currentColor",size:c=24,strokeWidth:f=2,absoluteStrokeWidth:g,className:h="",children:i,iconNode:j,...k},l)=>(0,b.createElement)("svg",{ref:l,...e,width:c,height:c,stroke:a,strokeWidth:g?24*Number(f)/Number(c):f,className:d("lucide",h),...!i&&!(a=>{for(let b in a)if(b.startsWith("aria-")||"role"===b||"title"===b)return!0})(k)&&{"aria-hidden":"true"},...k},[...j.map(([a,c])=>(0,b.createElement)(a,c)),...Array.isArray(i)?i:[i]])),g=(a,e)=>{let g=(0,b.forwardRef)(({className:g,...h},i)=>(0,b.createElement)(f,{ref:i,iconNode:e,className:d(`lucide-${c(a).replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}`,`lucide-${a}`,g),...h}));return g.displayName=c(a),g};a.s(["default",()=>g],489252)},269554,a=>{"use strict";let b=(0,a.i(489252).default)("circle-check-big",[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]]);a.s(["CheckCircle",()=>b],269554)},373351,a=>{"use strict";let b=(0,a.i(489252).default)("circle-x",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);a.s(["XCircle",()=>b],373351)},338708,a=>{"use strict";var b=a.i(352844),c=a.i(269554),d=a.i(373351),e=a.i(42783),f=a.i(228720),g=a.i(487536),h=a.i(977538);a.i(147775),a.i(721594),a.i(534286),a.i(158638),a.i(463893);let i=({status:a,title:f,description:g,userIntentRequired:i,retriesRemaining:j,hasSelectedCta:k,onContinue:l,onRetry:m})=>{let n=(0,e.useMemo)(()=>{switch(a){case"loading":default:return;case"success":return i?{label:k?"Continuing...":"Continue",onClick:l,disabled:k,loading:k}:void 0;case"error":return j>0?{label:"Retry",onClick:m}:void 0}},[a,k,l,m]),o=(0,e.useMemo)(()=>({loading:"loading",ready:"subtle",disabled:"subtle",success:"success",error:"error"})[a]||"loading",[a]);return(0,b.jsx)(h.S,{icon:"loading"===a||"ready"===a?void 0:"success"===a?c.CheckCircle:d.XCircle,iconVariant:o,title:f,subtitle:g,primaryCta:n,watermark:!0})},j={component:()=>{let{lastScreen:a,data:c,navigate:d,setModalData:h}=(0,g.a)(),{status:j,token:k,waitForResult:l,reset:m,execute:n}=(0,f.a)(),o=(0,e.useRef)([]),p=a=>{o.current=[a,...o.current]},[q,r]=(0,e.useState)(!0);(0,e.useEffect)(()=>(p(setTimeout(r,1e3,!1)),()=>{o.current.forEach(a=>clearTimeout(a)),o.current=[]}),[]);let[s,t]=(0,e.useState)(""),[u,v]=(0,e.useState)("Checking that you are a human..."),[w,x]=(0,e.useState)(!1),[y,z]=(0,e.useState)(3),A=c?.captchaModalData,B=async b=>{try{await A?.callback(b),A?.onSuccessNavigateTo&&d(A?.onSuccessNavigateTo,!1)}catch(b){if(b instanceof f.C)return;h({errorModalData:{error:b,previousScreen:a||"LandingScreen"}}),d(A?.onErrorNavigateTo||"ErrorScreen",!1)}};return(0,e.useEffect)(()=>{"success"===j?p(setTimeout(async()=>{let a=await l();!a||A?.userIntentRequired||B(a)},1e3)):"ready"===j&&p(setTimeout(()=>{"ready"===j&&n()},500))},[j]),(0,e.useEffect)(()=>{if(!q)switch(j){case"success":t("Success!"),v("CAPTCHA passed successfully."),A?.userIntentRequired||setTimeout(()=>{x(!0),B(k)},2e3);break;case"loading":t(""),v("Checking that you are a human...");break;case"error":t("Something went wrong"),v(y<=0?"If you use an adblocker or VPN, try disabling and re-attempting.":"You did not pass CAPTCHA. Please try again.")}},[j,q,w]),(0,b.jsx)(i,{status:j,title:s,description:u,userIntentRequired:A?.userIntentRequired,retriesRemaining:y,hasSelectedCta:w,onContinue:()=>{x(!0),B(k)},onRetry:async()=>{if(y<=0)return;z(a=>a-1),m(),n();let a=await l();!a||A?.userIntentRequired||B(a)}})}};a.s(["CaptchaScreen",()=>j,"CaptchaScreenView",()=>i,"default",()=>j])}];

//# sourceMappingURL=a6365__pnpm_08980457._.js.map